  ...
  return(
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        ...
        <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/sedans"
        ...
        <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/suvs"
        target="_blank">Ver mais</a>
        </div>
        ...
        <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo"
        target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
